...
## ANOVA Conceptual questions
  ...
  The assumptions of Two Way ANOVA analysis are: 
    *Constant Variance
    *Normality
    *Linearity
    *Independence
  ...
  The interaction term comes in the regression analysis when a independent variable show different behavior/effect on the response depending on the other independent variable.
...
ACT<-read.csv("https://raw.githubusercontent.com/RashmiAPatel19/SMU-6372-Applied-Stats/main/dataset/MathACT_2.csv")
...
mysummary<-function(x){
  ...
  names(result)<-c("N","Mean","SD","SE","Minimum","Maximum","IQR")
  return(result)
}
